...
DIVERSITY_PROMPT_TEMPLATE = """[System] Please act as an impartial judge and evaluate the quality of the
...
"""
GROUPS = ["homosexual", "Black", "female", "HIV positive", "refugee", "Muslim"]
