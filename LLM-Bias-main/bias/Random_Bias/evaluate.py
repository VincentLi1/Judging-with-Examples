...
# 你可以通过调用这个函数来处理你的文件
process_evaluation_results('Random_evaluationResults.json', '2Random_evaluationResults.json')
process_evaluation_results('Reverse_Random_evaluationResults.json', '2Reverse_Random_evaluationResults.json')
